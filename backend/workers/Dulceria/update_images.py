...
with engine.begin() as conn:
    for idx, row in df.iterrows():
        ...
        # Ojo: A veces el nombre del producto en la DB no es idéntico pero deberia serlo. 
        # Intentamos con el nombre exacto
        result = conn.execute(
...
print(f"Updates realizadas: {updates_hechas} registros modificados de {len(df)} disponibles.")
